...
public interface ICompilerVisitor<Result> : IParseTreeVisitor<Result> {
	...
	Result VisitCompiler([NotNull] CompilerParser.CompilerContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitNumber([NotNull] CompilerParser.NumberContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="CompilerParser.condition"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitCondition([NotNull] CompilerParser.ConditionContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="CompilerParser.if"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitIf([NotNull] CompilerParser.IfContext context);
	/// <summary>
	/// Visit a parse tree produced by <see cref="CompilerParser.while"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitWhile([NotNull] CompilerParser.WhileContext context);
}
